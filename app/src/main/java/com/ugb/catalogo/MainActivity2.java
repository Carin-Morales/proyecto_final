...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agregar_adidas);
    ...
    void guardar_agenda(){
        try {
            ...
            String result = db_agenda.administrar_adidas(id, nombre, direccion, telefono, email, urlCompletaImg, accion);
    ...
    void regresarListaAmigos() {
        ...
        if (accion.equals("nuevo") || accion.equals("modificar")) {
            iListaAmigos = new Intent(MainActivity2.this, adidas.class);
        } else {
            ...
            iListaAmigos = new Intent(MainActivity2.this, nike.class);
        }
