...
public class MainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agregar_nike);
    ...
    void guardar_agenda(){
        try {
            ...
            db_agenda = new BD(MainActivity1.this, "",null,1);
    ...
    void regresarListaAmigos() {
        ...
        if (accion.equals("nuevo") || accion.equals("modificar")) {
            iListaAmigos = new Intent(MainActivity1.this, adidas.class);
        } else {
            // Acción eliminar, redirige a la clase deseada después de eliminar un registro
            // Aquí puedes especificar a qué clase deseas redirigir en caso de eliminar un registro
            iListaAmigos = new Intent(MainActivity1.this, nike.class);
        }
    ...
    private void tomarFotoAmigo(){
        ...
        if( tomarFotoIntent.resolveActivity(getPackageManager())!=null ){
            ...
            try{
                ...
                if( fotoAmigo!=null ){
                    Uri uriFotoAmigo = FileProvider.getUriForFile(MainActivity1.this,
                            "com.ugb.catalogo.fileprovider", fotoAmigo);
